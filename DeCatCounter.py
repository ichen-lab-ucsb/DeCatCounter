...
# function to translate a single codon
def print_to_file(file_path, thing, len_bc1, len_bc2):
	file_path.write(">" + str('fwd')+str(" - ")+str(thing['name'])+"\n")
	file_path.write(thing['seq'][len_bc1:len(thing['seq'])-len_bc2] +"\n")

# function to print fasta format
def print_to_file_rc(file_path, thing, len_bc1, len_bc2):
	file_path.write(">" + str('rev')+str(" - ")+str(thing['name'])+"\n")
	file_path.write(str(Seq(thing['seq'][len_bc1:len(thing['seq'])-len_bc2]).reverse_complement()) +"\n")

# function to split sequence based on constant regions positions
...
# function to split a sequence into codons
...
# function to translate a dna sequence in a single frame
